...
function generate() {
    ...
    // Generate Locations Array of Objects
    locations = [
      {
        _id: ObjectId('5a299c06569692131061e6c1'),
      ...
      {
        _id: ObjectId('5a299c06569692131061e6c2'),
      ...
      {
        _id: ObjectId('5a299c06569692131061e6c3'),
    ...
    // Save Locations Array of Objects
    for(var i = 0; i < locations.length; i++ ){
      db.collection('locations').save(locations[i]);
    }

    // Generate events array of objects
    events = [
      {
        _id:{
          name: 'Descartes League Meet #1',
          date: new Date('12/09/17'),
          locationID: ObjectId('5a299c06569692131061e6c1')
        },
        eventInformation: {
      ...
      },
      {
        _id:{
          ...
          locationID: ObjectId('5a299c06569692131061e6c2')
        },
        eventInformation: {
      ...
      },
      {
        _id:{
          ...
          date: new Date('12/09/17'),
          locationID: ObjectId('5a299c06569692131061e6c3')
        },
        eventInformation: {
