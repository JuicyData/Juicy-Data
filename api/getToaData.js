...
// 	headers: {'X-Application-Origin': 'JuicyData', 'X-TOA-Key': apiKey}
// })
// var eventKeys = [] //Currently ongoing events
...
// 		var eventKeys = []
// 		toaApi.get('/events').then(function(response) {
// 			for (var i = 0; i < response.data.length; i++) {
// 				if(response.data[i].season_key == '1718'){
// 					console.log(response.data[i].event_key)
// 					eventKeys.push(response.data[i].event_key)
// 				}
// 			}
